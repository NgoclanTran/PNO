...
# Form implementation generated from reading ui file 'Robot_GUI_v3.ui'
#
# Created: Tue Apr 21 12:25:38 2015
...
class Ui_Form(Qt.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout_autonoom.addWidget(self.pushButton_pos, 0, 2, 1, 1)
        ...
        self.gridLayout_besturing.addItem(spacerItem, 1, 0, 1, 1)
        ...
        self.gridLayout_besturing.addItem(spacerItem1, 1, 4, 1, 1)
        ...
        self.gridLayout_commandos.addItem(spacerItem4, 0, 0, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_commandos.addItem(spacerItem5, 0, 2, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Sensorwaarden.sizePolicy().hasHeightForWidth())
        self.Sensorwaarden.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addLayout(self.gridLayout_sensorwaarden, 1, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.verticalLayout_camerabeeld, 0, 1, 1, 2)
        ...
        self.gridLayout.addLayout(self.verticalLayout_kaart, 1, 1, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_adjustLeft.setText(_translate("Form", "Align left", None))
        self.pushButton_adjustRight.setText(_translate("Form", "Align right", None))
...
#VERWERKING INFO
    ...
    def processInfo(self,data):
        ...
        if (data[0:2]=='--'):
            ...
            (xIjzer,yIjzer) = makeMap((xIjzer,yIjzer), positionList)
