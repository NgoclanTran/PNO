...
# Form implementation generated from reading ui file 'Robot_GUI_V4.ui'
#
# Created: Tue Apr 21 14:47:41 2015
...
class Ui_Form(Qt.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.gridLayout_toestand = QtGui.QGridLayout()
        self.gridLayout_toestand.setObjectName(_fromUtf8("gridLayout_toestand"))
        self.toestand = QtGui.QLabel(Form)
        self.toestand.setObjectName(_fromUtf8("toestand"))
        self.gridLayout_toestand.addWidget(self.toestand, 0, 1, 1, 1)
        spacerItem10 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_toestand.addItem(spacerItem10, 0, 0, 1, 1)
        spacerItem11 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_toestand.addItem(spacerItem11, 0, 2, 1, 1)
        self.gridLayout.addLayout(self.gridLayout_toestand, 0, 2, 1, 1)
    ...
    def processInfo(self,data):
        ...
        if (data[0:2]=='--'):
            ...
            while i < len(gesplitsteLijst):
                ...
                print posOr,image
                i+=2
                self.updateWorld(posOr[:len(posOr)-1], posOr[-1], image[0], image[1])
            (xIjzer,yIjzer) = makeMap((xIjzer,yIjzer), positionList)
            self.updateDebug("map updated")
            self.emit(QtCore.SIGNAL("setKaart"))
